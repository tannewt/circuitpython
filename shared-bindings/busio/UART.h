...
extern mp_float_t common_hal_busio_uart_get_write_timeout(busio_uart_obj_t *self);
extern void common_hal_busio_uart_set_write_timeout(busio_uart_obj_t *self, mp_float_t write_timeout);
